...
dataset4 = read_csv('e2_Teste.csv', header=0, delimiter=';')
...
dataset6 = read_csv('e3_Teste.csv', header=0, delimiter=';')
...
dataset8 = read_csv('e4_Teste.csv', header=0, delimiter=';')
...
C = ['2018-08-20', '2018-10-04', '2018-11-05', '2018-12-10', '2019-01-14', '2019-02-18', '2019-04-10', '2019-06-13', '2019-07-08', '2019-08-13', '2019-09-23', '2019-10-22', '2019-11-06']

#####Gráfico P20 Infestado#############################################################
arq = read_csv(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\Previsao\Nova pasta\lotacao1.csv', header=0, delimiter=';')
dados = arq.values
tam = len(arq)
...
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\Previsao\Nova pasta\Repeticoes\mf\P20Inf\Treinamentos_1.png', dpi=dpi*2)
pyplot.close()
...
dpi = fig1.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\Previsao\Nova pasta\Repeticoes\mf\P20Inf\Boxplot_1.png', dpi=dpi*2)
pyplot.close()
...
pyplot.xlabel('Real')
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\Previsao\Nova pasta\Repeticoes\mf\P20Inf\Dispersao_1.png', dpi=dpi*2)
pyplot.close()
...
file = open(r"C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\Previsao\Nova pasta\Repeticoes\mf\P20Inf\_1.txt", "w")
...
arq = read_csv(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\Previsao\Nova pasta\lotacao2.csv', header=0, delimiter=';')
dados = arq.values
tam = len(arq)
data = dados[:, 0]
dia = data[(tam-12):,]
...
ax.plot(C, inv_yhat2, label='Predito P20 MIRA', linestyle='--', marker='o')
#pyplot.plot_date(dia, peso[(tam-12):], label='Taxa de lotação', linestyle='--', marker='o')#[(tam-12):] para pegar o 12 últimos dados da coluna dias
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\Previsao\Nova pasta\Repeticoes\mf\P20Mira\Treinamentos_1.png', dpi=dpi*2)
pyplot.close()
...
dpi = fig1.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\Previsao\Nova pasta\Repeticoes\mf\P20Mira\Boxplot_1.png', dpi=dpi*2)
pyplot.close()
#Gráfico de Dispersão
...
pyplot.ylabel('Predito')
pyplot.xlabel('Real')
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\Previsao\Nova pasta\Repeticoes\mf\P20Mira\Dispersao_1.png', dpi=dpi*2)
pyplot.close()
...
file = open(r"C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\Previsao\Nova pasta\Repeticoes\mf\P20Mira\_1.txt", "w")
...
arq = read_csv(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\Previsao\Nova pasta\lotacao3.csv', header=0, delimiter=';')
dados = arq.values
tam = len(arq)
data = dados[:, 0]
dia = data[(tam-12):,]
...
ax.plot(C, inv_yhat3, label='Predito P21 Inf', linestyle='--', marker='o')
#pyplot.plot_date(dia, peso[(tam-12):], label='Taxa de lotação', linestyle='--', marker='o')#[(tam-12):] para pegar o 12 últimos dados da coluna dias
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\Previsao\Nova pasta\Repeticoes\mf\P21Inf\Treinamentos_1.png', dpi=dpi*2)
pyplot.close()
...
dpi = fig1.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\Previsao\Nova pasta\Repeticoes\mf\P21Inf\Boxplot_1.png', dpi=dpi*2)
pyplot.close()
#Gráfico de Dispersão
...
pyplot.ylabel('Predito')
pyplot.xlabel('Real')
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\Previsao\Nova pasta\Repeticoes\mf\P21Inf\Dispersao_1.png', dpi=dpi*2)
pyplot.close()
...
file = open(r"C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\Previsao\Nova pasta\Repeticoes\mf\P21Inf\_1.txt", "w")
...
arq = read_csv(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\Previsao\Nova pasta\lotacao4.csv', header=0, delimiter=';')
dados = arq.values
tam = len(arq)
data = dados[:, 0]
dia = data[(tam-12):,]
...
ax.plot(C, inv_yhat4, label='Predito P21 MIRA', linestyle='--', marker='o')
#pyplot.plot_date(dia, peso[(tam-12):], label='Taxa de lotação', linestyle='--', marker='o')#[(tam-12):] para pegar o 12 últimos dados da coluna dias
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\Previsao\Nova pasta\Repeticoes\mf\P21Mira\Treinamentos_1.png', dpi=dpi*2)
pyplot.close()
...
dpi = fig1.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\Previsao\Nova pasta\Repeticoes\mf\P21Mira\Boxplot_1.png', dpi=dpi*2)
pyplot.close()
#Gráfico de Dispersão
...
pyplot.ylabel('Predito')
pyplot.xlabel('Real')
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\Previsao\Nova pasta\Repeticoes\mf\P21Mira\Dispersao_1.png', dpi=dpi*2)
pyplot.close()
...
file = open(r"C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\Previsao\Nova pasta\Repeticoes\mf\P21Mira\_1.txt", "w")
...
with open(r"C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\Previsao\Nova pasta\saida_rede.csv", 'w', newline='') as file:
...
caminho = r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\Previsao\Nova pasta\Repeticoes\mf'

dados = read_csv(r"C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\Previsao\Nova pasta\saida_rede.csv", header=0, delimiter=';')
...
print(p1, dados11[(tam11-49):, -1] + inv_yhat1[12])
print(p2, dados21[(tam21-45):, -1] + inv_yhat2[12])
print(p3, dados31[(tam31-42):, -1] + inv_yhat3[12])
print(p4, dados41[(tam41-36):, -1] + inv_yhat4[12])

if p1 == (dados11[(tam11-49):, -1] + inv_yhat1[12]):
	mark1 = folium.CircleMarker(location=[-31.323459, -53.988220],
							...
							fill_opacity=0.7)
	m.add_child(mark1)
elif p1 < (dados11[(tam11-49):, -1] + inv_yhat1[12]):
	mark1 = folium.CircleMarker(location=[-31.323459, -53.988220],
							radius = 6,
...
if p2 == (dados21[(tam21-45):, -1] + inv_yhat2[12]):
	mark2 = folium.CircleMarker(location=[-31.323239, -53.983092],
							...
							fill_opacity=0.7)
	m.add_child(mark2)
elif p2 < (dados21[(tam21-45):, -1] + inv_yhat2[12]):
	mark2 = folium.CircleMarker(location=[-31.323239, -53.983092],
							radius = 6,
							popup="Inserir animais",
							fill=False, # Set fill to True
...
if p3 == (dados31[(tam31-42):, -1] + inv_yhat3[12]):
	mark3 = folium.CircleMarker(location=[-31.319280, -53.988660],
							...
							fill_opacity=0.7)
	m.add_child(mark3)
elif p3 < (dados31[(tam31-42):, -1] + inv_yhat3[12]):
	mark3 = folium.CircleMarker(location=[-31.319280, -53.988660],
							radius = 6,
							popup="Inserir animais",
							fill=False, # Set fill to True
...
if p4 == (dados41[(tam41-36):, -1] + inv_yhat4[12]):
	mark4 = folium.CircleMarker(location=[-31.320114, -53.983263],
							...
							fill_opacity=0.7)
	m.add_child(mark4)
elif p4 < (dados41[(tam41-36):, -1] + inv_yhat4[12]):
	mark4 = folium.CircleMarker(location=[-31.320114, -53.983263],
							radius = 6,
							popup="Inserir animais",
							fill=False, # Set fill to True
