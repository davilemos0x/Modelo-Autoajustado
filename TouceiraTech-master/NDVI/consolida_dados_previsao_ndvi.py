...
clima= cur.fetchall()
		...
		#futuro
ent.append([mes, ano, 15, ndvi, clima[0][0], clima[0][7], clima[0][14],
					...
					clima[0][27], clima[0][28], clima[0][29], ant[1]])
...
#futuro
header = ['mes', 'ano', 'numerodias', 'ndvianterior', 'tmin', 'dptmin', 'vartmin', 'tmed', 
...
with open('entclima_ndvi4.csv', 'w', newline='') as myfile:
