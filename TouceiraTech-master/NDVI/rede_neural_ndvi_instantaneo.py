...
cmh = os.path.join(caminho, 'NDVI_TratSim') 
################################################Potreiro 20 Infestado############################################################# 
# load dataset
dataset1 = read_csv('entrada_Inf_ndvi.csv', header=0, index_col=0, delimiter=';')
values1 = dataset1.values
# integer encode direction
encoder = LabelEncoder()

dataset2 = read_csv('e1_ndvi_Teste.csv', header=0, index_col=0, delimiter=';')
...
if not os.path.exists('M_INF_NDVI.h5'):
	...
	#model.save('M_INF_NDVI.h5')
	#------------------
else:
	#------------------
	# load the network's architecture
	model = load_model('M_INF_NDVI.h5')
	history =  model
	#------------------
...
# load dataset
dataset3 = read_csv('entrada_Mira_ndvi.csv', header=0, index_col=0, delimiter=';')
values3 = dataset3.values
# integer encode direction
encoder = LabelEncoder()

dataset4 = read_csv('e2_ndvi_Teste.csv', header=0, index_col=0, delimiter=';')
...
if not os.path.exists('M_MIRA_NDVI.h5'):
	print('modelo inexistente... criando modelo...')
	# design network
	model = Sequential()
	#model.add(LSTM(30, input_shape=(train_X.shape[1], train_X.shape[2]),  kernel_initializer='normal', activation='tanh', return_sequences = True))#bom para 1 e 2
	...
	# save the network's architecture
	print('Salvando modelo...')
	#model.save('M_MIRA_NDVI.h5')
	#------------------
else:
	#------------------
	# load the network's architecture
	model = load_model('M_MIRA_NDVI.h5')
	history =  model
	#------------------
	print('Modelo encontrado e carregado')
...
# load dataset
dataset5 = read_csv('entrada_Inf_ndvi.csv', header=0, index_col=0, delimiter=';')
values5 = dataset5.values
# integer encode direction
encoder = LabelEncoder()

dataset6 = read_csv('e3_ndvi_Teste.csv', header=0, index_col=0, delimiter=';')
...
# load dataset
dataset7 = read_csv('entrada_Mira_ndvi.csv', header=0, index_col=0, delimiter=';')
values7 = dataset7.values
# integer encode direction
encoder = LabelEncoder()

dataset8 = read_csv('e4_ndvi_Teste.csv', header=0, index_col=0, delimiter=';')
...
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\NDVI\Repeticoes\Instantaneo\P20Inf\Treinamentos_10.png', dpi=dpi*2)
pyplot.close()
...
dpi = fig1.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\NDVI\Repeticoes\Instantaneo\P20Inf\Boxplot_10.png', dpi=dpi*2)
pyplot.close()
...
pyplot.xlabel('Real')
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\NDVI\Repeticoes\Instantaneo\P20Inf\Dispersao_10.png', dpi=dpi*2)
pyplot.close()
...
file = open(r"C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\NDVI\Repeticoes\Instantaneo\P20Inf\_10.txt", "w")
...
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\NDVI\Repeticoes\Instantaneo\P20Mira\Treinamentos_10.png', dpi=dpi*2)
pyplot.close()
...
dpi = fig1.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\NDVI\Repeticoes\Instantaneo\P20Mira\Boxplot_10.png', dpi=dpi*2)
pyplot.close()
#Gráfico de Dispersão
...
pyplot.ylabel('Predito')
pyplot.xlabel('Real')
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\NDVI\Repeticoes\Instantaneo\P20Mira\Dispersao_10.png', dpi=dpi*2)
pyplot.close()
...
file = open(r"C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\NDVI\Repeticoes\Instantaneo\P20Mira\_10.txt", "w")
...
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\NDVI\Repeticoes\Instantaneo\P21Inf\Treinamentos_10.png', dpi=dpi*2)
pyplot.close()
...
dpi = fig1.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\NDVI\Repeticoes\Instantaneo\P21Inf\Boxplot_10.png', dpi=dpi*2)
pyplot.close()
#Gráfico de Dispersão
...
pyplot.ylabel('Predito')
pyplot.xlabel('Real')
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\NDVI\Repeticoes\Instantaneo\P21Inf\Dispersao_10.png', dpi=dpi*2)
pyplot.close()
...
file = open(r"C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\NDVI\Repeticoes\Instantaneo\P21Inf\_10.txt", "w")
...
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\NDVI\Repeticoes\Instantaneo\P21Mira\Treinamentos_10.png', dpi=dpi*2)
pyplot.close()
...
dpi = fig1.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\NDVI\Repeticoes\Instantaneo\P21Mira\Boxplot_10.png', dpi=dpi*2)
pyplot.close()
#Gráfico de Dispersão
...
pyplot.ylabel('Predito')
pyplot.xlabel('Real')
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\NDVI\Repeticoes\Instantaneo\P21Mira\Dispersao_10.png', dpi=dpi*2)
pyplot.close()
...
file = open(r"C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\NDVI\Repeticoes\Instantaneo\P21Mira\_10.txt", "w")
