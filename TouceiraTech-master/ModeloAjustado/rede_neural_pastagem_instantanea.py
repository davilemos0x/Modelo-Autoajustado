...
cmh = os.path.join(caminho, 'Potreiro_Naylor')  
###################################################Potreiro 20####################################################################
# load dataset
...
dpi = fig1.get_dpi()
pyplot.savefig(cmh + '\P20Inf_Boxplot_ModeloAjus.png', dpi=dpi*2)
pyplot.close()
...
pyplot.xlabel('Real')
pyplot.savefig(cmh + '\P20Inf_Dispersao_ModeloAjus.png', dpi=dpi*2)
pyplot.close()
...
dpi = fig1.get_dpi()
pyplot.savefig(cmh + '\P20Mira_Boxplot_ModeloAjus.png', dpi=dpi*2)
pyplot.close()
...
pyplot.ylabel('Predito')
pyplot.xlabel('Real')
pyplot.savefig(cmh + '\P20Mira_Dispersao_ModeloAjus.png', dpi=dpi*2)
pyplot.close()
########################################################################################################################
arq = read_csv(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\lotacao1.csv', header=0, delimiter=';')
...
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(cmh + '\P20Inf_ModeloAjus.png', dpi=dpi*2)
pyplot.close()


arq = read_csv(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\lotacao2.csv', header=0, delimiter=';')
...
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(cmh + '\P20Mira_ModeloAjus.png', dpi=dpi*2)
pyplot.close()
...
dpi = fig1.get_dpi()
pyplot.savefig(cmh + '\P21Inf_Boxplot_ModeloAjus.png', dpi=dpi*2)
pyplot.close()
...
pyplot.ylabel('Predito')
pyplot.xlabel('Real')
pyplot.savefig(cmh + '\P21Inf_Dispersao_ModeloAjus.png', dpi=dpi*2)
pyplot.close()
...
dpi = fig1.get_dpi()
pyplot.savefig(cmh + '\P21Mira_Boxplot_ModeloAjus.png', dpi=dpi*2)
pyplot.close()
...
pyplot.ylabel('Predito')
pyplot.xlabel('Real')
pyplot.savefig(cmh + '\P21Mira_Dispersao_ModeloAjus.png', dpi=dpi*2)
pyplot.close()
...
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(cmh + '\P21Inf_ModeloAjus.png', dpi=dpi*2)
pyplot.close()

arq = read_csv(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\lotacao4.csv', header=0, delimiter=';')
...
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(cmh + '\P21Mira_ModeloAjus.png', dpi=dpi*2)
pyplot.close()
