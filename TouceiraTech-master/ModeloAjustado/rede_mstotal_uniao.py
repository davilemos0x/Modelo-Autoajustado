...
r'''
# load dataset
dataset1 = read_csv('entrada_Inf_CN.csv', header=0, index_col=0, delimiter=';')
values1 = dataset1.values
# integer encode direction
encoder = LabelEncoder()

dataset2 = read_csv('e1_Teste.csv', header=0, index_col=0, delimiter=';')
...
if not os.path.exists('M_INF_CN.h5'):
	...
	#model.save('M_INF_CN.h5')
	#------------------
else:
	#------------------
	# load the network's architecture
	model = load_model('M_INF_CN.h5')
	history =  model
	#------------------
...
dataset4 = read_csv('e2_Teste.csv', header=0, index_col=0, delimiter=';')
...
if not os.path.exists('M_MIRA_CNF.h5'):
	print('modelo inexistente... criando modelo...')
	# design network
	model = Sequential()
	#model.add(LSTM(30, input_shape=(train_X.shape[1], train_X.shape[2]),  kernel_initializer='normal', activation='tanh', return_sequences = True))#bom para 1 e 2
	...
	# save the network's architecture
	print('Salvando modelo...')
	#model.save('M_MIRA_CNM_CNF.h5')
	#------------------
else:
	#------------------
	# load the network's architecture
	model = load_model('M_MIRA_CNM_CNF.h5')
	history =  model
	#------------------
	print('Modelo encontrado e carregado')
...
dataset8 = read_csv('e4_Teste.csv', header=0, index_col=0, delimiter=';')
...
if not os.path.exists('M_MIRA_CNM_CNF.h5'):
	print('modelo inexistente... criando modelo...')
	# design network
	model = Sequential()
	#model.add(LSTM(30, input_shape=(train_X.shape[1], train_X.shape[2]),  kernel_initializer='normal', activation='tanh', return_sequences = True))#bom para 1 e 2
...
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Inf_CN\P20Inf\Treinamentos_10.png', dpi=dpi*2)
pyplot.close()
...
dpi = fig1.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Inf_CN\P20Inf\Boxplot_10.png', dpi=dpi*2)
pyplot.close()
...
pyplot.xlabel('Real')
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Inf_CN\P20Inf\Dispersao_10.png', dpi=dpi*2)
pyplot.close()
...
print('Predito')
print(inv_yhat1.round(0))

file = open(r"C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Inf_CN\P20Inf\_10.txt", "a")
file.write('\n\r' + 'P20 - Infestado' + '\n')
...
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P20Mira\Treinamentos_9.png', dpi=dpi*2)
pyplot.close()
...
dpi = fig1.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P20Mira\Boxplot_9.png', dpi=dpi*2)
pyplot.close()
#Gráfico de Dispersão
...
pyplot.ylabel('Predito')
pyplot.xlabel('Real')
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P20Mira\Dispersao_9.png', dpi=dpi*2)
pyplot.close()
...
file = open(r"C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P20Mira\_9.txt", "a")
file.write('\n\r' + 'P20 - Mirapasto' + '\n')
...
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Inf_CN\P21Inf\Treinamentos_9.png', dpi=dpi*2)
pyplot.close()
...
dpi = fig1.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Inf_CN\P21Inf\Boxplot_9.png', dpi=dpi*2)
pyplot.close()
#Gráfico de Dispersão
...
pyplot.ylabel('Predito')
pyplot.xlabel('Real')
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Inf_CN\P21Inf\Dispersao_9.png', dpi=dpi*2)
pyplot.close()
...
file = open(r"C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Inf_CN\P21Inf\_9.txt", "a")
file.write('\n\r' + 'P21 - Infestado' + '\n')
...
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P21Mira\Treinamentos_9.png', dpi=dpi*2)
pyplot.close()
...
dpi = fig1.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P21Mira\Boxplot_9.png', dpi=dpi*2)
pyplot.close()
#Gráfico de Dispersão
...
pyplot.ylabel('Predito')
pyplot.xlabel('Real')
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P21Mira\Dispersao_9.png', dpi=dpi*2)
pyplot.close()
...
file = open(r"C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P21Mira\_9.txt", "a")
file.write('\n\r' + 'P21 - Mirapasto' + '\n')
