...
log = open('log.txt', 'a')
log.write("------Uniao Cristina ModeloAjustado Excecução iniciada em: " + str(now) + "\n\n")

caminho = r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado'
cmh = os.path.join(caminho, 'Total') 
################################################Potreiro 20 Infestado############################################################# 
# load dataset
dataset1 = read_csv('entrada_Mira_CNM_CNF.csv', header=0, index_col=0, delimiter=';')
values1 = dataset1.values
# integer encode direction
encoder = LabelEncoder()

dataset2 = read_csv('e1_cristina_Teste.csv', header=0, index_col=0, delimiter=';')
...
if not os.path.exists('M_TOTAL.h5'):
	...
	#model.save('M_TOTAL.h5')
	#------------------
else:
	#------------------
	# load the network's architecture
	model = load_model('M_TOTAL.h5')
	history =  model
	#------------------
...
# load dataset
dataset3 = read_csv('entrada_Mira_CNM_CNF.csv', header=0, index_col=0, delimiter=';')
values3 = dataset3.values
# integer encode direction
encoder = LabelEncoder()

dataset4 = read_csv('e2_cristina_Teste.csv', header=0, index_col=0, delimiter=';')
...
r''' 
# load dataset
dataset5 = read_csv('entrada_Inf_CN.csv', header=0, index_col=0, delimiter=';')
values5 = dataset5.values
# integer encode direction
encoder = LabelEncoder()

dataset6 = read_csv('e3_cristina_Teste.csv', header=0, index_col=0, delimiter=';')
...
# load dataset
dataset7 = read_csv('entrada_Mira_CNM_CNF.csv', header=0, index_col=0, delimiter=';')
values7 = dataset7.values
# integer encode direction
encoder = LabelEncoder()

dataset8 = read_csv('e4_cristina_Teste.csv', header=0, index_col=0, delimiter=';')
...
fig.autofmt_xdate()
ax.plot(dia, inv_y1, label='Real P1', linestyle='--', marker='o')
ax.plot(dia, inv_yhat1, label='Predito P1', linestyle='--', marker='o')
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P1\Treinamentos_10.png', dpi=dpi*2)
pyplot.close()
...
pyplot.title('P1')
dpi = fig1.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P1\Boxplot_10.png', dpi=dpi*2)
pyplot.close()
...
pyplot.xlabel('Real')
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P1\Dispersao_10.png', dpi=dpi*2)
pyplot.close()
...
file = open(r"C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P1\_10.txt", "w")
file.write('P1' + '\n')
...
pyplot.ylabel('kg/ha/dia')
fig.autofmt_xdate()
ax.plot(dia, inv_y2, label='Real P2', linestyle='--', marker='o')
ax.plot(dia, inv_yhat2, label='Predito P2', linestyle='--', marker='o')#tam - 12 para plotar apenas as 12 últimas amostras
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P2\Treinamentos_10.png', dpi=dpi*2)
pyplot.close()
...
pyplot.title('P2')
dpi = fig1.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P2\Boxplot_10.png', dpi=dpi*2)
pyplot.close()
#Gráfico de Dispersão
...
pyplot.ylabel('Predito')
pyplot.xlabel('Real')
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P2\Dispersao_10.png', dpi=dpi*2)
pyplot.close()
...
print('Predito')
print(inv_yhat2.round(1))

file = open(r"C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P2\_10.txt", "w")
file.write('P2' + '\n')
...
pyplot.ylabel('kg/ha/dia')
fig.autofmt_xdate()
ax.plot(dia, inv_y3, label='Real P3', linestyle='--', marker='o')
ax.plot(dia, inv_yhat3, label='Predito P3', linestyle='--', marker='o')
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Inf_CN\P3\Treinamentos_100.png', dpi=dpi*2)
pyplot.close()
...
pyplot.title('P3')
dpi = fig1.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Inf_CN\P3\Boxplot_100.png', dpi=dpi*2)
pyplot.close()
#Gráfico de Dispersão
...
pyplot.ylabel('Predito')
pyplot.xlabel('Real')
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Inf_CN\P3\Dispersao_100.png', dpi=dpi*2)
pyplot.close()
...
print('Real')
print(inv_y3.round(0))
print('Predito')
print(inv_yhat3.round(1))

file = open(r"C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Inf_CN\P3\_100.txt", "w")
file.write('P3' + '\n')
...
pyplot.ylabel('kg/ha/dia')
fig.autofmt_xdate()
ax.plot(dia, inv_y4, label='Real P4', linestyle='--', marker='o')
ax.plot(dia, inv_yhat4, label='Predito P4', linestyle='--', marker='o')
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P4\Treinamentos_10.png', dpi=dpi*2)
pyplot.close()
...
pyplot.title('P4')
dpi = fig1.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P4\Boxplot_10.png', dpi=dpi*2)
pyplot.close()
#Gráfico de Dispersão
...
pyplot.ylabel('Predito')
pyplot.xlabel('Real')
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P4\Dispersao_10.png', dpi=dpi*2)
pyplot.close()
...
print('Real')
print(inv_y4.round(0))
print('Predito')
print(inv_yhat4.round(1))

file = open(r"C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P4\_10.txt", "w")
file.write('P4' + '\n')
...
dataset2 = read_csv('e5_cristina_Teste.csv', header=0, index_col=0, delimiter=';')
values2 = dataset2.values
# integer encode direction
encoder = LabelEncoder()
...
################################################Potreiro 20 Mirapasto############################################################# 
# load dataset
dataset3 = read_csv('entrada_Inf_CN.csv', header=0, index_col=0, delimiter=';')
values3 = dataset3.values
# integer encode direction
encoder = LabelEncoder()

dataset4 = read_csv('e6_cristina_Teste.csv', header=0, index_col=0, delimiter=';')
values4 = dataset4.values
# integer encode direction
encoder = LabelEncoder()
...
################################################Potreiro 21 Infestado############################################################# 
# load dataset
dataset5 = read_csv('entrada_Mira_CNM_CNF.csv', header=0, index_col=0, delimiter=';')
values5 = dataset5.values
# integer encode direction
encoder = LabelEncoder()

dataset6 = read_csv('e7_cristina_Teste.csv', header=0, index_col=0, delimiter=';')
values6 = dataset6.values
# integer encode direction
encoder = LabelEncoder()
...
################################################Potreiro 21 Mirapasto############################################################# 
# load dataset
dataset7 = read_csv('entrada_Inf_CN.csv', header=0, index_col=0, delimiter=';')
values7 = dataset7.values
# integer encode direction
encoder = LabelEncoder()

dataset8 = read_csv('e8_cristina_Teste.csv', header=0, index_col=0, delimiter=';')
values8 = dataset8.values
# integer encode direction
encoder = LabelEncoder()
...
pyplot.ylabel('kg/ha/dia')
fig.autofmt_xdate()
ax.plot(dia, inv_y1, label='Real P5', linestyle='--', marker='o')
ax.plot(dia, inv_yhat1, label='Predito P5', linestyle='--', marker='o')
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P5\Treinamentos_10.png', dpi=dpi*2)
pyplot.close()
...
pyplot.title('P5')
dpi = fig1.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P5\Boxplot_10.png', dpi=dpi*2)
pyplot.close()
#Gráfico de Dispersão
pyplot.scatter(inv_y1, inv_yhat1)
range = [inv_y1.min(), inv_yhat1.max()]
...
pyplot.ylabel('Predito')
pyplot.xlabel('Real')
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P5\Dispersao_10.png', dpi=dpi*2)
pyplot.close()
...
file = open(r"C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P5\_10.txt", "w")
file.write('P5' + '\n')
file.write('Test RMSE:' + '%.3f' % rmse + '\n')
file.write('R2 linear:' + str(r_value ** 2) + '\n')
file.write("R2 Polinomial:" + str(r1) + '\r')
...
pyplot.ylabel('kg/ha/dia')
fig.autofmt_xdate()
ax.plot(dia, inv_y2, label='Real P6', linestyle='--', marker='o')
ax.plot(dia, inv_yhat2, label='Predito P6', linestyle='--', marker='o')#tam - 12 para plotar apenas as 12 últimas amostras
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Inf_CN\P6\Treinamentos_100.png', dpi=dpi*2)
pyplot.close()
...
pyplot.title('P6')
dpi = fig1.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Inf_CN\P6\Boxplot_100.png', dpi=dpi*2)
pyplot.close()
#Gráfico de Dispersão
pyplot.scatter(inv_y2, inv_yhat2)
range = [inv_y2.min(), inv_yhat2.max()]
...
pyplot.ylabel('Predito')
pyplot.xlabel('Real')
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Inf_CN\P6\Dispersao_100.png', dpi=dpi*2)
pyplot.close()
...
file = open(r"C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Inf_CN\P6\_100.txt", "w")
file.write('P6' + '\n')
file.write('Test RMSE:' + '%.3f' % rmse2 + '\n')
file.write('R2 linear:' + str(r_value2 ** 2) + '\n')
file.write("R2 Polinomial:" + str(r2) + '\r')
...
pyplot.ylabel('kg/ha/dia')
fig.autofmt_xdate()
ax.plot(dia, inv_y3, label='Real P7', linestyle='--', marker='o')
ax.plot(dia, inv_yhat3, label='Predito P7', linestyle='--', marker='o')
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P7\Treinamentos_10.png', dpi=dpi*2)
pyplot.close()
...
pyplot.title('P7')
dpi = fig1.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P7\Boxplot_10.png', dpi=dpi*2)
pyplot.close()
#Gráfico de Dispersão
pyplot.scatter(inv_y3, inv_yhat3)
range = [inv_y3.min(), inv_yhat3.max()]
...
pyplot.ylabel('Predito')
pyplot.xlabel('Real')
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P7\Dispersao_10.png', dpi=dpi*2)
pyplot.close()
...
file = open(r"C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P7\_10.txt", "w")
file.write('P7' + '\n')
file.write('Test RMSE:' + '%.3f' % rmse3 + '\n')
file.write('R2 linear:' + str(r_value3 ** 2) + '\n')
file.write("R2 Polinomial:" + str(r3) + '\r')
...
pyplot.ylabel('kg/ha/dia')
fig.autofmt_xdate()
ax.plot(dia, inv_y4, label='Real P8', linestyle='--', marker='o')
ax.plot(dia, inv_yhat4, label='Predito P8', linestyle='--', marker='o')
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Inf_CN\P8\Treinamentos_100.png', dpi=dpi*2)
pyplot.close()
...
pyplot.title('P8')
dpi = fig1.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Inf_CN\P8\Boxplot_100.png', dpi=dpi*2)
pyplot.close()
#Gráfico de Dispersão
pyplot.scatter(inv_y4, inv_yhat4)
range = [inv_y4.min(), inv_yhat4.max()]
...
pyplot.ylabel('Predito')
pyplot.xlabel('Real')
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Inf_CN\P8\Dispersao_100.png', dpi=dpi*2)
pyplot.close()
...
file = open(r"C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Inf_CN\P8\_100.txt", "w")
file.write('P8' + '\n')
file.write('Test RMSE:' + '%.3f' % rmse4 + '\n')
file.write('R2 linear:' + str(r_value4 ** 2) + '\n')
file.write("R2 Polinomial:" + str(r4) + '\r')
...
dataset2 = read_csv('e9_cristina_Teste.csv', header=0, index_col=0, delimiter=';')
values2 = dataset2.values
# integer encode direction
encoder = LabelEncoder()
...
pyplot.ylabel('kg/ha/dia')
fig.autofmt_xdate()
ax.plot(dia, inv_y1, label='Real P9', linestyle='--', marker='o')
ax.plot(dia, inv_yhat1, label='Predito P9', linestyle='--', marker='o')
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P9\Treinamentos_10.png', dpi=dpi*2)
pyplot.close()
...
pyplot.title('P9')
dpi = fig1.get_dpi()
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P9\Boxplot_10.png', dpi=dpi*2)
pyplot.close()
#Gráfico de Dispersão
pyplot.scatter(inv_y1, inv_yhat1)
range = [inv_y1.min(), inv_yhat1.max()]
...
pyplot.ylabel('Predito')
pyplot.xlabel('Real')
pyplot.savefig(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P9\Dispersao_10.png', dpi=dpi*2)
pyplot.close()
...
file = open(r"C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloAjustado\Repeticoes\Uniao\Mira_CNM_CNF\P9\_10.txt", "w")
file.write('P9' + '\n')
file.write('Test RMSE:' + '%.3f' % rmse + '\n')
file.write('R2 linear:' + str(r_value ** 2) + '\n')
file.write("R2 Polinomial:" + str(r1) + '\r')
...
log = open('log.txt', 'a')
log.write("------Uniao Cristina Excecução Total encerrada em: " + str(now) + "\n\n")