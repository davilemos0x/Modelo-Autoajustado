...
caminho = r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloOriginal'
cmh = os.path.join(caminho, 'TratSim') 
################################################Potreiro 20 Infestado############################################################# 
# load dataset
dataset1 = read_csv('entrada_Inf.csv', header=0, index_col=0, delimiter=';')
...
# load dataset
dataset3 = read_csv('entrada_Mira.csv', header=0, index_col=0, delimiter=';')
...
if not os.path.exists('M_MIRA.h5'):
	print('modelo inexistente... criando modelo...')
	# design network
	model = Sequential()
	#model.add(LSTM(30, input_shape=(train_X.shape[1], train_X.shape[2]),  kernel_initializer='normal', activation='tanh', return_sequences = True))#bom para 1 e 2
	...
	# save the network's architecture
	print('Salvando modelo...')
	model.save('M_MIRA.h5')
	#------------------
else:
	#------------------
	# load the network's architecture
	model = load_model('M_MIRA.h5')
	history =  model
	#------------------
	print('Modelo encontrado e carregado')
...
# load dataset
dataset5 = read_csv('entrada_Inf.csv', header=0, index_col=0, delimiter=';')
...
# load dataset
dataset7 = read_csv('entrada_Mira.csv', header=0, index_col=0, delimiter=';')
...
arq = read_csv(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloOriginal\lotacao1.csv', header=0, delimiter=';')
dados = arq.values
tam = len(arq)
tam2 =	len(dataset2)
peso = dados[:, -1]
...
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(cmh + '\P20Inf_Trat_ModeloOriginal.png', dpi=dpi*2)
pyplot.close()
...
dpi = fig1.get_dpi()
pyplot.savefig(cmh + '\P20Inf_Boxplot_Trat_ModeloOriginal.png', dpi=dpi*2)
pyplot.close()
...
pyplot.xlabel('Real')
pyplot.savefig(cmh + '\P20Inf_Dispersao_Trat_ModeloOriginal.png', dpi=dpi*2)
pyplot.close()
...
arq = read_csv(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloOriginal\lotacao2.csv', header=0, delimiter=';')
dados = arq.values
tam = len(arq)
tam2 = len(dataset4)
peso = dados[:, -1]
...
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(cmh + '\P20Mira_Trat_ModeloOriginal.png', dpi=dpi*2)
pyplot.close()
...
dpi = fig1.get_dpi()
pyplot.savefig(cmh + '\P20Mira_Boxplot_Trat_ModeloOriginal.png', dpi=dpi*2)
pyplot.close()
#Gráfico de Dispersão
...
pyplot.ylabel('Predito')
pyplot.xlabel('Real')
pyplot.savefig(cmh + '\P20Mira_Dispersao_Trat_ModeloOriginal.png', dpi=dpi*2)
pyplot.close()
...
arq = read_csv(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloOriginal\lotacao3.csv', header=0, delimiter=';')
dados = arq.values
tam = len(arq)
tam2 = len(dataset6)
peso = dados[:, -1]
...
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(cmh + '\P21Inf_Trat_ModeloOriginal.png', dpi=dpi*2)
pyplot.close()
...
dpi = fig1.get_dpi()
pyplot.savefig(cmh + '\P21Inf_Boxplot_Trat_ModeloOriginal.png', dpi=dpi*2)
pyplot.close()
#Gráfico de Dispersão
...
pyplot.ylabel('Predito')
pyplot.xlabel('Real')
pyplot.savefig(cmh + '\P21Inf_Dispersao_Trat_ModeloOriginal.png', dpi=dpi*2)
pyplot.close()
...
arq = read_csv(r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloOriginal\lotacao4.csv', header=0, delimiter=';')
dados = arq.values
tam = len(arq)
tam2 = len(dataset8)
peso = dados[:, -1]
...
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(cmh + '\P21Mira_Trat_ModeloOriginal.png', dpi=dpi*2)
pyplot.close()
...
dpi = fig1.get_dpi()
pyplot.savefig(cmh + '\P21Mira_Boxplot_Trat_ModeloOriginal.png', dpi=dpi*2)
pyplot.close()
#Gráfico de Dispersão
...
pyplot.ylabel('Predito')
pyplot.xlabel('Real')
pyplot.savefig(cmh + '\P21Mira_Dispersao_Trat_ModeloOriginal.png', dpi=dpi*2)
pyplot.close()
