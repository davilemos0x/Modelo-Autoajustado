...
log = open('log.txt', 'a')
log.write("------Instantanea ModeloOriginal Excecução iniciada em: " + str(now) + "\n\n")

caminho = r'C:\Users\Ânderson Fischoeder\Desktop\Tese\Modelos\ModeloOriginal'
cmh = os.path.join(caminho, 'Potreiro')   
###################################################Potreiro 20####################################################################
# load dataset
dataset = read_csv('e1.csv', header=0, index_col=0, delimiter=';')
...
dpi = fig1.get_dpi()
pyplot.savefig(cmh + '\P20Inf_Boxplot_ModeloOriginal.png', dpi=dpi*2)
pyplot.close()
...
pyplot.xlabel('Real')
pyplot.savefig(cmh + '\P20Inf_Dispersao_ModeloOriginal.png', dpi=dpi*2)
pyplot.close()
...
########################################################################################################################
# load dataset
dataset = read_csv('e2.csv', header=0, index_col=0, delimiter=';')
values = dataset.values
# integer encode direction
encoder = LabelEncoder()
...
dpi = fig1.get_dpi()
pyplot.savefig(cmh + '\P20Mira_Boxplot_ModeloOriginal.png', dpi=dpi*2)
pyplot.close()
...
pyplot.ylabel('Predito')
pyplot.xlabel('Real')
pyplot.savefig(cmh + '\P20Mira_Dispersao_ModeloOriginal.png', dpi=dpi*2)
pyplot.close()
########################################################################################################################
...
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(cmh + '\P20Inf_ModeloOriginal.png', dpi=dpi*2)
pyplot.close()
...
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(cmh + '\P20Mira_ModeloOriginal.png', dpi=dpi*2)
pyplot.close()
...
####################################################Potreiro 21##########################################################################################
# load dataset
dataset = read_csv('e3.csv', header=0, index_col=0, delimiter=';')
values = dataset.values
# integer encode direction
encoder = LabelEncoder()
...
dpi = fig1.get_dpi()
pyplot.savefig(cmh + '\P21Inf_Boxplot_ModeloOriginal.png', dpi=dpi*2)
pyplot.close()
...
pyplot.ylabel('Predito')
pyplot.xlabel('Real')
pyplot.savefig(cmh + '\P21Inf_Dispersao_ModeloOriginal.png', dpi=dpi*2)
pyplot.close()
...
########################################################################################################################
# load dataset
dataset = read_csv('e4.csv', header=0, index_col=0, delimiter=';')
values = dataset.values
# integer encode direction
encoder = LabelEncoder()
...
dpi = fig1.get_dpi()
pyplot.savefig(cmh + '\P21Mira_Boxplot_ModeloOriginal.png', dpi=dpi*2)
pyplot.close()
...
pyplot.ylabel('Predito')
pyplot.xlabel('Real')
pyplot.savefig(cmh + '\P21Mira_Dispersao_ModeloOriginal.png', dpi=dpi*2)
pyplot.close()
...
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(cmh + '\P21Inf_ModeloOriginal.png', dpi=dpi*2)
pyplot.close()
...
pyplot.legend()
dpi = fig.get_dpi()
pyplot.savefig(cmh + '\P21Mira_ModeloOriginal.png', dpi=dpi*2)
pyplot.close()
