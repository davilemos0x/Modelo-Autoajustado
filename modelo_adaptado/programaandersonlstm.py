...
while(aux<valor_inteiro):
	...
	name4 = now
	os.mkdir(str(name4))
	caminho_destino = str('/home/bianca/Área de Trabalho/MODELO/MODELO ADAPTADO/LSTM/' + str(name4))
	...
	caminho_origem = str('/home/bianca/Área de Trabalho/MODELO/MODELO ADAPTADO/LSTM/ManDados.txt')
	...
	caminho_origem = str('/home/bianca/Área de Trabalho/MODELO/MODELO ADAPTADO/LSTM/DefTreinoMO.txt')
	shutil.move(caminho_origem, caminho_destino)
	...
	caminho_origem = str('/home/bianca/Área de Trabalho/MODELO/MODELO ADAPTADO/LSTM/CalcSKT.txt')
	shutil.move(caminho_origem, caminho_destino)
	...
	caminho_origem = str('/home/bianca/Área de Trabalho/MODELO/MODELO ADAPTADO/LSTM/GBoxP_SKT.png')
	shutil.move(caminho_origem, caminho_destino)
	caminho_origem = str('/home/bianca/Área de Trabalho/MODELO/MODELO ADAPTADO/LSTM/GDisp_SKT.png')
	shutil.move(caminho_origem, caminho_destino)
	...
	caminho_origem = str('/home/bianca/Área de Trabalho/MODELO/MODELO ADAPTADO/LSTM/Log_SKT.txt')
	shutil.move(caminho_origem, caminho_destino)
	...
	caminho_origem = str('/home/bianca/Área de Trabalho/MODELO/MODELO ADAPTADO/LSTM/RS.txt')
	shutil.move(caminho_origem, caminho_destino)
	...
	caminho_origem = str('/home/bianca/Área de Trabalho/MODELO/MODELO ADAPTADO/LSTM/TreinoMA.txt')
	shutil.move(caminho_origem, caminho_destino)
	...
	caminho_origem = str('/home/bianca/Área de Trabalho/MODELO/MODELO ADAPTADO/LSTM/CalcCKT.txt')
	shutil.move(caminho_origem, caminho_destino)
	...
	pyplot.savefig('/home/bianca/Área de Trabalho/MODELO/MODELO ADAPTADO/LSTM/GBoxP_CKT.png', dpi=dpi*2)
	...
	caminho_origem = str('/home/bianca/Área de Trabalho/MODELO/MODELO ADAPTADO/LSTM/GBoxP_CKT.png')
	shutil.move(caminho_origem, caminho_destino)
	caminho_origem = str('/home/bianca/Área de Trabalho/MODELO/MODELO ADAPTADO/LSTM/GDisp_CKT.png')
	shutil.move(caminho_origem, caminho_destino)
	...
	file = open('/home/bianca/Área de Trabalho/MODELO/MODELO ADAPTADO/LSTM/Log_CKT.txt', "w")
	file.write('P20 - Infestado' + '\n')
	file.write('Test RMSE:' + '%.3f' % rmse + '\n')
	file.write('R2 linear:' + str(r_value ** 2) + '\n')
	file.write("R2 Polinomial:" + str(r1) + '\r')
	...
	caminho_origem = str('/home/bianca/Área de Trabalho/MODELO/MODELO ADAPTADO/LSTM/Log_CKT.txt')
	shutil.move(caminho_origem, caminho_destino)
	...
	caminho_origem = str('/home/bianca/Área de Trabalho/MODELO/MODELO ADAPTADO/LSTM/KT')
	shutil.move(caminho_origem, caminho_destino)
