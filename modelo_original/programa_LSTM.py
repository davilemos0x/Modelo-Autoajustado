...
while(aux<valor_inteiro):
	...
	name4 = now
	os.mkdir(str(name4))
	caminho_destino = str('/home/bianca/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/LSTM/' + str(name4))
	...
	caminho = r'/home/bianca/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/LSTM/'
	cmh = os.path.join(caminho, 'P20Inf')
	################################################Potreiro 20 Infestado#############################################################
	# load dataset
	dataset1 = read_csv('/home/bianca/Área de Trabalho/MODELOS/e1.csv', header=0, index_col=0, delimiter=';')
	...
	caminho_origem = str('/home/bianca/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/LSTM/ManDados.txt')
	...
	caminho_origem = str('/home/bianca/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/LSTM/DefTreinoMO.txt')
	shutil.move(caminho_origem, caminho_destino)
	...
	caminho_origem = str('/home/bianca/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/LSTM/CalcSKT.txt')
	shutil.move(caminho_origem, caminho_destino)
	...
	caminho_origem = str('/home/bianca/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/LSTM/GBoxP_SKT.png')
	shutil.move(caminho_origem, caminho_destino)
	caminho_origem = str('/home/bianca/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/LSTM/GDisp_SKT.png')
	shutil.move(caminho_origem, caminho_destino)
	...
	caminho_origem = str('/home/bianca/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/LSTM/Log_SKT.txt')
	shutil.move(caminho_origem, caminho_destino)
	...
	def build_model(hp):
		...
		model.add(layers.LSTM(
	    		units=hp.Int("lstm_units", min_value=30, max_value=512, step=32),
	  		activation=hp.Choice("lstm_activation", ["relu", "tanh"]),
	   		return_sequences=True,
	   		input_shape=(1, 33)
	))
		model.add(layers.LSTM(
	    		units=hp.Int("lstm_units_1", min_value=15, max_value=512, step=32),
	   		activation=hp.Choice("lstm_activation", ["relu", "tanh"])
	))
	...
	caminho_origem = str('/home/bianca/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/LSTM/RS.txt')
	shutil.move(caminho_origem, caminho_destino)
	...
	caminho_origem = str('/home/bianca/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/LSTM/TreinoMA.txt')
	shutil.move(caminho_origem, caminho_destino)
	...
	caminho_origem = str('/home/bianca/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/LSTM/CalcCKT.txt')
	shutil.move(caminho_origem, caminho_destino)
	...
	# Salva a figura no Google Drive
	pyplot.savefig('/home/bianca/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/LSTM/GBoxP_CKT.png', dpi=dpi*2)
	...
	caminho_origem = str('/home/bianca/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/LSTM/GBoxP_CKT.png')
	shutil.move(caminho_origem, caminho_destino)
	caminho_origem = str('/home/bianca/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/LSTM/GDisp_CKT.png')
	shutil.move(caminho_origem, caminho_destino)
	...
	file = open('/home/bianca/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/LSTM/Log_CKT.txt', "w")
	file.write('P20 - Infestado' + '\n')
	file.write('Test RMSE:' + '%.3f' % rmse + '\n')
	file.write('R2 linear:' + str(r_value ** 2) + '\n')
	file.write("R2 Polinomial:" + str(r1) + '\r')
	...
	caminho_origem = str('/home/bianca/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/LSTM/Log_CKT.txt')
	shutil.move(caminho_origem, caminho_destino)
	...
	caminho_origem = str('/home/bianca/Área de Trabalho/MODELOS/MODELO ORIGINAL (ÂNDERSON)/LSTM/KT')
	shutil.move(caminho_origem, caminho_destino)
